...
const SkillDetailPage = () => {
    ...
    return (_jsxs("div", { className: "min-h-screen gradient-bg relative", children: [_jsx(ParticleBackground, {}), _jsx(ProfileDropdown, {}), _jsx(Confetti, { show: showConfetti }), _jsxs("div", { className: "relative z-10 max-w-3xl mx-auto p-4 md:p-8", children: [_jsxs("button", { onClick: () => navigate("/skill-gap"), className: "flex items-center gap-2 text-muted-foreground hover:text-foreground mb-6", children: [_jsx(ArrowLeft, { className: "w-4 h-4" }), " Back to Skill Gap"] }), _jsx("div", { className: "glass-card p-6 mb-6 animate-fade-in", children: _jsxs("div", { className: "flex justify-between items-start", children: [_jsx("h1", { className: "text-3xl font-bold text-foreground", children: skill }), _jsxs("div", { className: "flex items-center gap-2 text-orange-500", children: [_jsx(Flame, { className: "w-5 h-5" }), _jsxs("span", { className: "font-bold", children: [streak, " days \uD83D\uDD25"] })] })] }) }), _jsxs("div", { className: "space-y-4", children: [_jsxs("div", { className: "glass-card p-6 animate-slide-up", children: [_jsxs("h2", { className: "font-bold text-foreground text-lg mb-2", children: ["\uD83E\uDDE0 What is ", skill, "?"] }), _jsx("p", { className: "text-muted-foreground", children: info.desc })] }), _jsxs("div", { className: "glass-card p-6 animate-slide-up", style: { animationDelay: "0.1s" }, children: [_jsxs("h2", { className: "font-bold text-foreground text-lg mb-2", children: ["\uD83C\uDFAF Why ", skill, " for YOUR career?"] }), _jsx("p", { className: "text-muted-foreground", children: info.why })] }), _jsxs("div", { className: "glass-card p-6 animate-slide-up", style: { animationDelay: "0.2s" }, children: [_jsx("h2", { className: "font-bold text-foreground text-lg mb-2", children: "\uD83D\uDCA1 Overview" }), _jsx("p", { className: "text-muted-foreground", children: info.overview })] }), _jsxs("div", { className: "glass-card p-6 animate-slide-up", style: { animationDelay: "0.3s" }, children: [_jsxs("h2", { className: "font-bold text-foreground text-lg mb-2", children: ["\uD83D\uDCC5 Daily Learning Plan (", user.learningTime, "/day)"] }), _jsxs("p", { className: "text-sm text-muted-foreground mb-4", children: ["Progress: ", completedCount, "/", info.plan.length, " days"] }), _jsx("div", { className: "w-full bg-secondary rounded-full h-2 mb-4", children: _jsx("div", { className: "bg-primary rounded-full h-2 transition-all", style: { width: `${(completedCount / info.plan.length) * 100}%` } }) }), _jsx("div", { className: "space-y-3", children: info.plan.map((day, i) => (_jsxs("div", { className: `flex items-center gap-3 p-3 rounded-lg transition-all ${completedDays[i] ? "bg-success/10" : "bg-secondary/50"}`, children: [_jsx(Checkbox, { checked: completedDays[i], onCheckedChange: () => toggleDay(i) }), _jsxs("span", { className: `text-sm ${completedDays[i]
                                                        ? "line-through text-muted-foreground"
                                                        : "text-foreground"}`, children: ["Day ", i + 1, ": ", day] })] }, i))) })] })] })] })] }));
};
