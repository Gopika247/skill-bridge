...
const applyThemeColors = (themeId, isDark) => {
...
export const AppProvider = ({ children }) => {
    ...
    const updateProfile = async (partial) => {
        ...
        if (partial.username !== undefined)
            dbFields.username = partial.username;
        if (partial.email !== undefined)
            dbFields.email = partial.email;
        if (partial.education !== undefined)
            dbFields.education = partial.education;
        if (partial.careerGoal !== undefined)
            dbFields.career_goal = partial.careerGoal;
        if (partial.skillLevel !== undefined)
            dbFields.skill_level = partial.skillLevel;
        if (partial.learningTime !== undefined)
            dbFields.learning_time = partial.learningTime;
        if (partial.knownSkills !== undefined)
            dbFields.known_skills = partial.knownSkills;
        if (partial.mentorName !== undefined)
            dbFields.mentor_name = partial.mentorName;
        if (partial.onboardingComplete !== undefined)
            dbFields.onboarding_complete = partial.onboardingComplete;
        if (partial.points !== undefined)
            dbFields.points = partial.points;
        if (partial.streak !== undefined)
            dbFields.streak = partial.streak;
        if (partial.profilePhoto !== undefined)
            dbFields.profile_photo = partial.profilePhoto;
        if (partial.phone !== undefined)
            dbFields.phone = partial.phone;
        if (partial.theme !== undefined)
            dbFields.theme = partial.theme;
        if (partial.fontSize !== undefined)
            dbFields.font_size = partial.fontSize;
        if (partial.lastStreakDate !== undefined)
            dbFields.last_streak_date = partial.lastStreakDate;
        if (partial.completedDays !== undefined)
            dbFields.completed_days = partial.completedDays;
